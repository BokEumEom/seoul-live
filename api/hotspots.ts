...
//
// **`citydata-bulk`를 대신한다.** 그쪽은 `AREA_NM`이 필수인 공식 OpenAPI라
// 명소당 1회씩 들어서, 121곳이면 갱신 한 번에 121회이고 하루 2,904회가 된다
// (한도는 1,000). 이쪽은 상류가 서울시 실시간 도시데이터 웹(SeoulRtd)이고
// **인증키를 안 쓴다** — 한 번의 호출로 121곳이 오고 쿼터를 1원도 안 쓴다.
//
