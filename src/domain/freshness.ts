 ...
 * 기본 1시간). 그래서 「4분 후 도착」이나 「잔여 568면」이 실제로는 한참 전
 * 값일 수 있는데, 예전에는 세 절이 전부 **「최대 1시간 전 기준이에요」**라고
 ...
 * 1시간 묵은 값이 갓 받은 값으로 둔갑해 **고치기 전보다 나빠진다.** 모르면
 * 화면이 예전 문구(「최대 1시간 전 기준」)로 돌아가는 것이 맞다.
 */
