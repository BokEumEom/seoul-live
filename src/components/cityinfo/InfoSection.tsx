...
interface Props {
   ...
   * 도시정보는 하루 1,000회 한도 때문에 3시간 캐시로 받는데, 그러면 「4분 후
   * 도착」이나 「잔여 568면」이 최대 3시간 묵은 값일 수 있다. 숫자만 크게 적고
...
export function InfoSection({ title, icon, count, note, children }: Props) {
  return (
