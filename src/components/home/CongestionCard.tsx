...
//
// 남던 빈틈 하나는 2026-08-28에 닫혔다: 예전에는 **요약에서 혼잡도가 아직
// 도착하기 전에** 인구 탭으로 넘어가면 등급을 못 본 채로 갔는데, 씨앗 심기가
// 되살아나면서 목록이 받아 둔 등급이 상세를 여는 순간 헤더에 꽂힌다
// (`AreaDetailScreen`의 `seededCongestion`).
//
